...
export type DietaryPreference = 'omnivore' | 'vegetarian' | 'vegan' | 'pescatarian' | 'keto' | 'mediterranean' | 'high_protein';
export type FastingPlan = '12:12' | '14:10' | '16:8' | '18:6' | '20:4' | '5:2' | '6:1' | 'custom';
export type FastingSelection = FastingPlan | 'none';
